...
import roosterMugImage from "../../../assets/images/home/accesories/rooster-mug.webp";
        ...
        <div className="accesories-section__grid-container">
          ...
          <div className="grid-container__item">
            ...
            <div className="grid-container__item-label">
              <p className="grid-container__item-label-text">Cat ramen pillow</p>
          ...
          <div className="grid-container__item">
            ...
            <div className="grid-container__item-label">
              <p className="grid-container__item-label-text">Black dragon cap</p>
              <BsArrowRight className="grid-container__item-label-icon" />
            </div>
          </div>
          <div className="grid-container__item">
          ...
          <div className="grid-container__item-label">
            <p className="grid-container__item-label-text">Rooster mug</p>
            <BsArrowRight className="grid-container__item-label-icon" />
          </div>
          </div>
          <div className="grid-container__item">
            ...
            <div className="grid-container__item-label">
              <p className="grid-container__item-label-text">Dragon tote bag</p>
              <BsArrowRight className="grid-container__item-label-icon" />
            </div>
          </div>
        </div>
